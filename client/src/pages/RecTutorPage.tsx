...
export default function RecTutorPage() {
  ...
  const [chatMode, setChatMode] = useState<'chat' | 'hint' | 'explanation'>('chat');
  ...
  const getProgressPercentage = () => {
    ...
    if (currentSession.targetType === 'questions') {
      return (currentSession.questionsAnswered / currentSession.sessionTarget) * 100;
    }
  ...
  const getAccuracyPercentage = () => {
    ...
    return (currentSession.correctAnswers / currentSession.questionsAnswered) * 100;
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  AI adapts to your learning style and pace, providing customized explanations and hints.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  Chat with your AI tutor, ask questions, and get step-by-step guidance through problems.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value: any) => 
                    setSessionOptions(prev => ({ ...prev, sessionType: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value: any) => 
                    setSessionOptions(prev => ({ ...prev, targetType: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                <Label>
                  {sessionOptions.targetType === 'questions' ? 'Questions' : 'Minutes'}: {sessionOptions.sessionTarget}
                </Label>
                <Slider
                  value={[sessionOptions.sessionTarget]}
                  onValueChange={(value) => 
                    setSessionOptions(prev => ({ ...prev, sessionTarget: value[0] }))
                  }
              ...
              <div>
                <Label>Difficulty Level: {sessionOptions.difficultyLevel}</Label>
                <Slider
                  value={[sessionOptions.difficultyLevel]}
                  onValueChange={(value) => 
                    setSessionOptions(prev => ({ ...prev, difficultyLevel: value[0] }))
                  }
                  max={5}
                  min={1}
                  step={1}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 capitalize">{currentSession?.sessionType} Practice</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold">
                  {currentSession?.questionsAnswered || 0}/{currentSession?.sessionTarget || 0}
                </div>
          ...
          <div className="lg:col-span-1">
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col">
                ...
                <Tabs value={chatMode} onValueChange={(value: any) => setChatMode(value)}>
                ...
                <div className="flex gap-2 mt-2">
                  <Input
                    ...
                    placeholder={
                      chatMode === 'hint' ? 'Ask for a hint...' :
                      chatMode === 'explanation' ? 'Ask about a concept...' :
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setRatings(prev => ({ ...prev, feedback: e.target.value }))}
