...
export default function AiAnalytics() {
  ...
  const recentProgressResult = processRecentProgressFromAsset(
  ...
  const processConceptMasteryData = () => {
    return Object.entries(conceptMasteryData)
  ...
  const handleGenerateAnalytics = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your personalized learning insights and study plan are ready to view.",
        variant: "default",
        dismisstimeout: 3000,
      });
      playSound("levelUp");
    ...
    return (
      <Card>
        ...
        <CardContent className="text-center py-8">
          ...
          <Button onClick={handleGenerateAnalytics} disabled={isGenerating}>
            {isGenerating ? (
    ...
    <Card className="analytics-card">
          ...
          <TabsContent value="overview" className="pt-4">
                    ...
                    {analytics.performanceMetrics?.overallPerformanceScore
                      ...
                      : Math.round(
                          ((user?.correctAnswers || 0) /
                            Math.max(1, user?.questionsAnswered || 1)) *
                            100,
                        )}
                    %
                  </div>
                    ...
                    {analytics.performanceMetrics?.learningVelocity
                      ...
                      : Math.round(
                          (user?.questionsAnswered || 0) /
                            Math.max(1, recentProgress.length || 1),
                        )}
                  </div>
                  <p className="text-muted-foreground text-sm">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
                ...
                <CardContent>
                  ...
                  !isProgressDataDummy ? (
                      ...
                      <div className="relative h-full flex items-end pb-8">
                        {recentProgress.map((entry: any, index: number) => (
                          <div
                            ...
                            style={{
                              height: `${Math.max(15, Math.min(100, (entry.totalScore / 20) * 100))}%`,
                            }}
                          >
                    ...
                    <div className="text-center p-8">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Complete more sessions to see your actual progress
                        chart.
                      </p>
                    </div>
                  )}
              ...
              {(() => {
                ...
                const hasReliableModuleData =
                  analytics.modulePerformance &&
                  analytics.modulePerformance.length > 0 &&
                  analytics.modulePerformance.some(
                    (module: any) => module.sessionCount >= 3,
                  );
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="relative min-h-[280px]">
                          ...
                          {/* Navigation buttons */}
                          {analytics.modulePerformance.filter(
                            (module: any) => module.sessionCount >= 3,
                          ).length > 1 && (
                            <div className="flex justify-center mt-4 space-x-3">
                              <Button
                                ...
                                onClick={() => {
                                  const carousel =
                                    document.getElementById("module-carousel");
                                  if (carousel) {
                                ...
                                onClick={() => {
                                  ...
                                  if (carousel) {
                                    ...
                                    const current = currentTranslate
                                      ? parseInt(currentTranslate[1])
                                      : 0;
                                    const reliableModules =
                                      analytics.modulePerformance.filter(
                                        (module: any) =>
                                          module.sessionCount >= 3,
                                      );
                                    const maxTranslate =
                                      -(reliableModules.length - 1) * 100;
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-center p-8">
                          ...
                          <p className="text-muted-foreground text-sm">
                            Complete more sessions to see meaningful module
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {analytics.learningPatterns?.totalSessions ||
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-medium ${
                          analytics.learningPatterns?.performanceTrend ===
                          "improving"
                            ? "text-green-600"
                            : analytics.learningPatterns?.performanceTrend ===
                                "declining"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(() => {
                      ...
                      return filteredWeaknesses.length > 0 ? (
                        ...
                        <p className="text-muted-foreground text-sm">
                          Complete more questions to identify areas for
                          improvement.
                        </p>
                      );
                    })()}
              ...
              <div className="space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-green-600">
                        {
                          processedConceptMasteries.filter(
                            (c) => c.weightedScore >= 80,
                          ).length
                        }
                      </div>
                      <p className="text-muted-foreground text-sm">
                      ...
                      <div className="text-3xl font-bold text-blue-600">
                        {
                          processedConceptMasteries.filter(
                            (c) =>
                              c.weightedScore >= 50 && c.weightedScore < 80,
                          ).length
                        }
                      </div>
                      <p className="text-muted-foreground text-sm">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Weighted mastery scores based on accuracy (40%),
                      consistency (30%), practice volume (20%), and mastery flag
                      (10%)
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      {processedConceptMasteries.map((concept, index) => (
                        <div
                          key={index}
                          className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm w-full h-full"
                        >
                              <div className="flex justify-between">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                Found in {concept.modules.length} module
                                {concept.modules.length > 1 ? "s" : ""}
                              </p>
                            ...
                            <div className="text-right">
                              <div
                                className={`text-2xl font-bold ${
                                  concept.weightedScore >= 80
                                    ? "text-green-600"
                                    : concept.weightedScore >= 50
                                      ? "text-blue-600"
                                      : "text-red-600"
                                }`}
                              >
                          ...
                          <div className="text-xs text-muted-foreground">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span>
                                {concept.breakdown.practiceVolumeScore}
                              </span>
                            </div>
                            <div className="flex justify-between">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center text-muted-foreground">
                      {processedConceptMasteries.length === 0 ? (
                        <p>
                          Complete more modules to see detailed concept
                          analysis.
                        </p>
                      ) : (
                        <p>
                          Showing {processedConceptMasteries.length} concepts
                          across all modules with weighted mastery scoring.
                        </p>
                      )}
                    </div>
                  </CardContent>
              ...
              <Card>
                <CardContent className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Complete some learning activities to see your concept
                    mastery analysis.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    The system tracks your performance across different math
                    concepts and calculates weighted mastery scores.
                  </p>
                </CardContent>
              </Card>
            )}
                ...
                {customStudyPlan && customStudyPlan.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground text-sm max-w-md mx-auto mb-4">
                      Generate a personalized study plan based on your current
                      analytics.
                    </p>
                    <Button
                      onClick={generateCustomStudyPlan}
      ...
      <CardFooter className="border-t pt-4 text-xs text-muted-foreground">
        <div className="flex items-center">
          ...
          Last updated:{" "}
          {analytics?.analysisDate
            ? new Date(analytics.analysisDate).toLocaleString()
            : "Never"}
        </div>
      </CardFooter>
    </Card>
