...
import { Home, Gamepad as GamepadIcon, Trophy, User, Menu, Palette, Users, Brain, Pencil, GraduationCap } from 'lucide-react';
import { useState } from 'react';
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet";

type NavigationProps = {
  active: 'home' | 'play' | 'leaderboard' | 'profile' | 'avatar' | 'multiplayer' | 'analytics' | 'create-a-quiz' | 'practice' | 'tutor';
};
...
export default function Navigation({ active }: NavigationProps) {
  ...
  const isAdvancedFeatureActive = ['avatar', 'multiplayer', 'analytics', 'create-a-quiz', 'tutor'].includes(active);
