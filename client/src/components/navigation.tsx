  ...
  const handleNavigation = (href: string, e?: React.MouseEvent) => {
    if (hasActiveSession) {
      ...
      toast({
        ...
        description:
          "Please complete your current module before navigating away.",
        variant: "destructive",
      });
      return false;
    }
      ...
      <div className="container mx-auto">
        <ul className="flex justify-around items-center h-full">
          <li className="flex flex-col items-center">
            ...
            >
              <Home
                className={`${active === "home" ? "h-5 w-5" : "h-4 w-4"}`}
              />
            </SessionAwareLink>
            <span
              className={`text-[8px] ${active === "home" ? "text-primary font-bold" : "text-gray-500"} mt-0.5`}
            >
              Home
            </span>
          </li>
          ...
          <li className="flex flex-col items-center">
            ...
            <div className="relative">
              ...
              >
                <Menu
                  className={`${isAdvancedFeatureActive ? "h-5 w-5" : "h-4 w-4"}`}
                />
              </button>
                ...
                <div className="fixed inset-x-0 bottom-12 z-50 bg-white border-t border-gray-200 shadow-xl rounded-t-3xl px-4 py-4 transition-all duration-300 ease-in-out">
                  ...
                  <div className="flex flex-wrap justify-around py-2 mt-2">
                    ...
                    >
                      ...
                      <span
                        className={`text-[11px] mt-1 ${active === "multiplayer" ? "font-semibold text-primary" : "text-gray-600"}`}
                      >
                        Multiplayer
                      </span>
                    </SessionAwareLink>
                    ...
                    >
                      ...
                      <span
                        className={`text-[11px] mt-1 ${active === "analytics" ? "font-semibold text-primary" : "text-gray-600"}`}
                      >
                        AI Analytics
                      </span>
                    </SessionAwareLink>
                    ...
                    >
                      ...
                      <span
                        className={`text-[11px] mt-1 ${active === "tutor" ? "font-semibold text-primary" : "text-gray-600"}`}
                      >
                        AI Tutor
                      </span>
                    </SessionAwareLink>
            ...
            <span
              className={`text-[8px] ${isAdvancedFeatureActive ? "text-primary font-bold" : "text-gray-500"} mt-0.5`}
            >
              More
            </span>
          </li>
          ...
          <li className="flex flex-col items-center">
            ...
            >
              <Trophy
                className={`${active === "leaderboard" ? "h-5 w-5" : "h-4 w-4"}`}
              />
            </SessionAwareLink>
            <span
              className={`text-[8px] ${active === "leaderboard" ? "text-primary font-bold" : "text-gray-500"} mt-0.5`}
            >
              Leaderboard
            </span>
          </li>
          ...
          <li className="flex flex-col items-center">
            ...
            >
              <User
                className={`${active === "profile" ? "h-5 w-5" : "h-4 w-4"}`}
              />
            </SessionAwareLink>
            <span
              className={`text-[8px] ${active === "profile" ? "text-primary font-bold" : "text-gray-500"} mt-0.5`}
            >
              Profile
            </span>
          </li>
